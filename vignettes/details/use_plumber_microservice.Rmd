---
title: "use_plumber_microservice"
editor_options: 
  markdown: 
    wrap: 80
---
...
-   Can't make inward calls for other services, That means plumber can't be
    ...
    HTTP to `read_table` and `write_table`. Circumventing this behaviour is
    possible with [***parallel
    execution***](https://blog.rstudio.com/2021/03/29/plumber-v1-1-0/#parallel-exec).
    However, this approach lacks the mechanism for cascading tasks.

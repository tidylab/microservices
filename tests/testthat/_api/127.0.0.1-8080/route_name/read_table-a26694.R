structure(list(url = "http://127.0.0.1:8080/route_name/read_table?name=xxx", 
    status_code = 400L, headers = structure(list(date = "Sun, 24 Oct 2021 00:20:52 GMT", 
    ...
    "list")), all_headers = list(list(status = 400L, version = "HTTP/1.1", 
        headers = structure(list(date = "Sun, 24 Oct 2021 00:20:52 GMT", 
            `content-type` = "application/json", `content-length` = "1349"), class = c("insensitive", 
    ...
    date = structure(1635034852, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 4.7e-05, 
    connect = 4.8e-05, pretransfer = 0.000107, starttransfer = 0.003547, 
    total = 0.003564)), class = "response")
